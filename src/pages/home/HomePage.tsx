            ...
            <section id="inicio" className="relative min-h-screen flex items-center justify-center px-8 md:px-16 lg:px-24 py-24">
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    ...
                    >
                        ...
                        <a
                            href="https://www.tiktok.com/@arf.rec"
                            target="_blank"
            ...
            <footer className="py-12 px-8 md:px-16 lg:px-24 border-t border-card-border">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="https://www.tiktok.com/@arf.rec" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-complementary transition-colors">
